...
declare global {
  ...
  const Link: typeof import('./libs/navigation')['Link']
  ...
  const config: typeof import('./libs/navigation')['config']
  ...
  const getPathname: typeof import('./libs/navigation')['getPathname']
  ...
  const i18n: typeof import('./libs/i18n')['default']
  ...
  const pathnames: typeof import('./libs/navigation')['pathnames']
  const redirect: typeof import('./libs/navigation')['redirect']
  ...
  const usePathname: typeof import('./libs/navigation')['usePathname']
  const useRouter: typeof import('./libs/navigation')['useRouter']
