...
export {}
declare global {
  const CookieSignatureMismatchError: typeof import('./utils/cookies')['CookieSignatureMismatchError']
  ...
  const ISolarChatRoundDotsLinear: typeof import('~icons/solar/chat-round-dots-linear')['default']
  const ISolarClipboardBroken: typeof import('~icons/solar/clipboard-broken')['default']
  const ISolarDocumentsLinear: typeof import('~icons/solar/documents-linear')['default']
  const ISolarHomeSmileLinear: typeof import('~icons/solar/home-smile-linear')['default']
  const ISolarInboxLinear: typeof import('~icons/solar/inbox-linear')['default']
  const ISolarSettingsLinear: typeof import('~icons/solar/settings-linear')['default']
  const ISolarShareLinear: typeof import('~icons/solar/share-linear')['default']
  const ISolarShieldKeyholeBold: typeof import('~icons/solar/shield-keyhole-bold')['default']
  const ISolarShieldUserBold: typeof import('~icons/solar/shield-user-bold')['default']
...
declare global {
  // @ts-ignore
  export type { State, ActionReturn, BaseOptions } from './utils/actions'
  import('./utils/actions')
  // @ts-ignore
  export type { CookieSignatureMismatchError } from './utils/cookies'
  import('./utils/cookies')
  // @ts-ignore
  export type { DayJSOptions } from './utils/formatter'
  import('./utils/formatter')
  // @ts-ignore
  export type { URLPatternParser } from './utils/middlewares'
  import('./utils/middlewares')
  // @ts-ignore
  export type { Page, R } from './utils/response'
  import('./utils/response')
  // @ts-ignore
  export type { TranslationKey } from './utils/strings'
  import('./utils/strings')
  // @ts-ignore
  export type { Expand, ExpandRecursively, DistributiveOmit, Keys, DistributiveKeys, DistributivePick, ReducerAction, ReducerActionBatch, ReducerDispatcher, Awaitable } from './utils/types'
  import('./utils/types')
}
