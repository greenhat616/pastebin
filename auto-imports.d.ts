...
declare global {
  ...
  const ISolarChatRound: typeof import('~icons/solar/chat-round')['default']
  ...
  const ISolarLayersLinear: typeof import('~icons/solar/layers-linear')['default']
  ...
  const ISolarUserCircleLinear: typeof import('~icons/solar/user-circle-linear')['default']
